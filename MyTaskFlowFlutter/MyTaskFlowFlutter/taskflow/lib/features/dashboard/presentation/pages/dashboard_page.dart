...
class _DashboardPageState extends ConsumerState<DashboardPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(dashboardNotifierProvider.notifier).loadDashboard());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: switch (state) {
        ...
        DashboardLoaded(:final stats, :final recentTasks) => _Loaded(
          greeting: greeting,
          stats: stats,
...
class _Loaded extends StatelessWidget {
  const _Loaded({required this.greeting, required this.stats, required this.recentTasks});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(_formattedDate(), style: Theme.of(context).textTheme.bodyMedium),
          ...
          Row(
            children: [
              Expanded(
                child: Text('Actividad reciente', style: Theme.of(context).textTheme.titleMedium),
              ),
              TextButton(
